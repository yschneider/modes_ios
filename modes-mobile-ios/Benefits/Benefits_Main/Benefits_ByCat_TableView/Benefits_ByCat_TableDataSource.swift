...
class Benefits_ByCat_TableDataSource: NSObject, UITableViewDataSource, UITableViewDelegate{
    ...
    override init() {
        myCategories = BenefitsViewModel().getCategories()
    }
   ...
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    FirebaseUtility.shared.browseCategorySelected(screenName: "benefits", contentType: "benefit", category: (parentVc?.parentVc?.viewModel!.selectedCategory)!)
