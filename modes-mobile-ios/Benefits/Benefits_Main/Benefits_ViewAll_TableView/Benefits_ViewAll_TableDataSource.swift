...
class Benefits_ViewAll_TableDataSource: NSObject, UITableViewDataSource, UITableViewDelegate{
    ...
    override init() {
        ...
        myBenefits = BenefitsViewModel().getAllBenefits()
 ...
 */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let benefit =  myBenefits[indexPath.row]
   ...
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        */
        ...
        parentVc?.parentVc?.vc3?.fromBenefitsVC = true
        parentVc?.parentVc?.showOverlay(view: (parentVc?.parentVc?.DetailsBenefits)!)
    
    FirebaseUtility.shared.ContentCardSelected(screenName: "Benefits", contentType: "BENEFITS", contentTitle: (parentVc?.parentVc?.viewModel!.self.selectedBenefit)!, category: "", displayFormat: "view all")
