...
class VertTwoCollDataSource: NSObject, UICollectionViewDataSource, UICollectionViewDelegate{
   ...
   func collectionView(_ collectionView: UICollectionView,
    ...
    FirebaseUtility.shared.searchResultSelected(contentType: "benefit", contentTitle: selectedBenefit!, category: (viewModel?.topic)!)
        ...
        */
        ...
        app.mainViewController?.benefitsVC?.vc3?.fromHomeVC = true
        app.mainViewController?.benefitsVC?.vc3?.backtoSearchResults = true
