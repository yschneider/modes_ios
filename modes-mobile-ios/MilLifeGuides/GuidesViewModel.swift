    ...
    func getCategories()-> [String]{
        ...
        */
        ...
        for item in results{
            ...
            let categories = item["Category"] as? String
            
            let values = categories?.split(separator: ",")
            for value in values!{
                list.append(String(value).trimmingCharacters(in: .whitespacesAndNewlines))
            }
