 ...
 */
   ...
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        */
        ...
        app.mainViewController?.benefitsVC?.vc3?.fromGuidesVC = true
        app.mainViewController?.benefitsVC?.viewModel?.selectedBenefit = selectedBenefit!.benefit!
        ...
        FirebaseUtility.shared.guideContentSelected(screenName: (parentVc?.guide?.Guide)!, guideContentType: "benefits", guideContentTitle: (selectedBenefit?.benefit)!)
