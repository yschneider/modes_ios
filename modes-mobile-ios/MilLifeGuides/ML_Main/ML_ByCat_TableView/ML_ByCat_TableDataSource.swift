...
class ML_ByCat_TableDataSource: NSObject, UITableViewDataSource, UITableViewDelegate{
    ...
    override init() {
        myCategories = GuidesViewModel().getCategories()
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.label.text = myCategories[indexPath.row]
   ...
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    FirebaseUtility.shared.browseCategorySelected(screenName: "millife guides", contentType: "guide", category: (parentVc?.parentVc?.viewModel!.selectedCategory)!)
