...
class FavoritesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if(!(viewModel?.getInstallation())!){
            ...
            constraintNoInstallationTop.constant = 0 //was 31
    ...
    @objc private func emailClicked(_ sender: UITapGestureRecognizer){
        ...
        FirebaseUtility.shared.installationInteraction(installationName: lblInstallationName.text!, installationInteraction: "email")
    ...
    @objc private func websiteClicked(_ sender: UITapGestureRecognizer){
        ...
        FirebaseUtility.shared.installationInteraction(installationName: lblInstallationName.text!, installationInteraction: "website")
    ...
    @objc private func phoneClicked(_ sender: UITapGestureRecognizer){
        ...
        if(location?.phone1 != nil && location?.phone1?.count ?? 0 > 0){
            ...
            FirebaseUtility.shared.installationInteraction(installationName: lblInstallationName.text!, installationInteraction: "phone")
    ...
    func tableView(_ tableView: UITableView, willSelectRowAt indexPath: IndexPath) -> IndexPath? {
        if(tableView == tableViewGuides){
            ...
            */
            ...
            var selectedGuide = viewModel?.getFavoriteGuides()[indexPath.row].name
            let app = UIApplication.shared.delegate as! AppDelegate
            app.mainViewController?.selectedIndex = 1
            app.mainViewController?.guidesVC?.vc3?.fromFavVC = true
            ...
            */
            ...
            let app = UIApplication.shared.delegate as! AppDelegate
            app.mainViewController?.selectedIndex = 2
            app.mainViewController?.benefitsVC?.vc3?.fromFavVC = true
            app.mainViewController?.benefitsVC?.viewModel?.selectedBenefit = selectedBenefit!
            app.mainViewController?.benefitsVC?.vc3?.loadBenefit()
            app.mainViewController?.benefitsVC?.showOverlay(view: (app.mainViewController?.benefitsVC?.DetailsBenefits)!)
            app.mainViewController?.loadBenefit()
