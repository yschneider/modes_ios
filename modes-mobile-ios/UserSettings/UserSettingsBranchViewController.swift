   ...
   // var picker = UIPickerView()
    ...
    @IBAction func touchSelect(_ sender: Any) {
        ...
        */
        ...
        parentVc?.toolBar.isHidden = false
        
        parentVc?.view.bringSubviewToFront((parentVc?.picker)!)
        parentVc?.view.bringSubviewToFront((parentVc?.toolBar)!)
        
        parentVc?.btnBack.isHidden = true
        finishButton.isHidden = true
        
        // focus on picker view
        UIAccessibility.post(notification: .layoutChanged, argument: parentVc?.picker)
...
extension UserSettingsViewController : UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        //below used before Done button added
        /*
